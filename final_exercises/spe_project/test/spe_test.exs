defmodule SPETest do
  ...
  test "start_job3" do
    assert {:ok, _spe} = SPE.start_link(num_workers: 1)
  ...
  test "multiple_jobs" do
    assert {:ok, _spe} = SPE.start_link(num_workers: 10)
  ...
  test "task_timing2" do
    assert {:ok, _spe} = SPE.start_link(num_workers: 2)
